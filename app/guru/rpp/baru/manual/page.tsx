// Halaman buat RPP manual (form penuh).
...
export const metadata = { title: "Buat RPP Manual — Guru" };

export default async function NewRppManualPage() {
  ...
  return (
    <div className="max-w-3xl">
      ...
      <h1 className="text-2xl font-bold tracking-tight text-foreground mb-4">Buat RPP Manual</h1>
      <RppForm
        action={createRpp}
